...
export class ElementAssembler extends ParentNodeAssembler {
    ...
    /**
     * Generate a unique identifier for the element among it's owner document
     * @param {NodeAssembler|Element|*} object
     * @returns {String}
     */
    static generateUniqueId(object) {
        const name = object.constructor.name
        const ownerDocument = getNodeOf(object).ownerDocument
        let id
        do id = name + Math.floor(Math.random() * UNIQUE_ID_MULTIPLIER)
