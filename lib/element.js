...
export class ElementAssembler extends ParentNodeAssembler {
    ...
    setAttribute(attr, value) {
        ...
        if((isFunctionType || type === 'string') && typeof value === 'string') {
            ...
            if(instance) instance.value = value
                ...
                this.setAttributeNode(new assembler({ value }))
            }
        }
        else {
    ...
    /**
     * this.setAttributeNode(new Lang)
     * this.setAttributeNode(document.createAttribute('lang'))
     *
    ...
    getAttributeNode(attr) {
        const { node, constructor } = this.node
