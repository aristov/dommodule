...
export class ElementAssembler extends ParentNodeAssembler {
    ...
    closest(object) {
        if(typeof object === TYPE_FUNCTION) {
            ...
            if(node) {
                const element = this.getInstanceOf(node)
        ...
        else return this.getInstanceOf(this.node.closest(object))
    }
    ...
    getElementsByClassName(classNames) {
        ...
        return map.call(nodes, node => {
            return this.getInstanceOf(node, elementAssembler)
        })
    }
    ...
    get attributes() {
        ...
        return map.call(this.node.attributes, node => {
            return this.getInstanceOf(node, attrAssembler)
        })
    }
