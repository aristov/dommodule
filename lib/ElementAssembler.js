...
export class ElementAssembler extends ParentNodeAssembler {
     ...
     */
    closest(object) {
        if(ElementAssembler.isPrototypeOf(object) || AttrAssembler.isPrototypeOf(object)) {
            const node = this.node.closest(object.selector)
            if(node) {
                const isAttr = AttrAssembler.isPrototypeOf(object)
                return isAttr?
                    object.getAttrOf(node) :
                    object.getInstanceOf(node)
            }
            return null
        }
     ...
     */
    getAttr(attr) {
        if(AttrAssembler.isPrototypeOf(attr)) {
    ...
    hasAttr(attr) {
        ...
        return AttrAssembler.isPrototypeOf(attr)?
    ...
    removeAttr(attr) {
        ...
        else if(AttrAssembler.isPrototypeOf(attr)) {
            const instance = attr.getAttrOf(this)
...
Object.defineProperty(NodeAssembler, 'ElementAssembler', { value : ElementAssembler })
