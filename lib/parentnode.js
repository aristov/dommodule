...
export class ParentNodeAssembler extends ChildNodeAssembler {
     ...
     */
    contains(object) {
        return this.node.contains(this.constructor.getNode(object))
    }
    ...
    insertBefore(node, child) {
        ...
        return this.getInstance(result, this.constructor.childNodeAssembler)
    }
    ...
    querySelectorAll(selectors) {
        ...
        const handler = node => this.getInstance(node, assembler)
    ...
    get childNodes() {
        return map.call(this.node.childNodes, node => {
            return this.getInstance(node, this.constructor.childNodeAssembler)
        })
    }
     ...
     */
    get firstChild() {
        return this.getInstance(this.node.firstChild, this.constructor.childNodeAssembler)
    }
     ...
     */
    get lastChild() {
        return this.getInstance(this.node.lastChild, this.constructor.childNodeAssembler)
    }
