...
export class ChildNodeAssembler extends NodeAssembler {
    /**
     * @param {{}} init
     * @param {*} [init.parentNode]
     * @override
     */
    assign(init) {
        super.assign(init)
        if(init.hasOwnProperty('parentNode')) {
            this.setProperty('parentNode', init.parentNode)
        }
    }
    ...
    static get setPropertyStopList() {
        return [...super.setPropertyStopList, 'parentNode']
    }
}

const { flatten } = ChildNodeAssembler

Object.defineProperty(NodeAssembler, 'ChildNodeAssembler', { value : ChildNodeAssembler })
