...
export class ParentNodeAssembler extends ChildNodeAssembler {
    ...
    find(subject, filter) {
        ...
        if(node) {
            if(typeof subject.getAttrOf === TYPE_FUNCTION) {
    ...
    on(type, callback, options) {
        if(typeof type === TYPE_FUNCTION && 'localName' in type) {
...
Object.defineProperty(NodeAssembler, 'ParentNodeAssembler', { value : ParentNodeAssembler })
